    ...
    <div class="section-authentication-cover">
        <div class="">
            <div class="row g-0">
                ...
                <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                    <img src="/assets/images/login-images/lc.jpg" class="img-fluid" width="1000" alt=""/>
                </div>
                    ...
                    <div class="card rounded-0 m-3 shadow-none bg-transparent mb-0">
                        <div class="card-body">
                            <div class="">
                                ...
                                <h6 class="font-weight-bold text-center">Language Center</h6>
                                <h6 class="font-weight-bold text-center">Universitas Halim Sanusi</h6>
